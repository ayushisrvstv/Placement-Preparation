			...
			<br>
				...
				<br>
					...
					<article class="col_4 pad_left2">
									...
									<form id="changee" action="ChangeEServlet" method="post">
                                  	...
                                  	<h3>Old Email:</h3>
										<div class="wrapper">
										<div class="bg"><input class="tb5" type="text" name="oemail"></div>
									...
									<h3>New Email:</h3>
										...
										<br>
										<br>
<a href="#" class="button" onclick="document.getElementById('changee').submit()"><span><span><strong>Change</strong></span></span></a>
<a href="#" class="button" onclick="location.href='changeEmail.jsp'"><span><span><strong>Reset</strong></span></span></a>
									</form>
