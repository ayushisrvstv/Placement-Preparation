			...
			<br>
				...
				<br>
					...
					<article class="col_4 pad_left2">
									...
									<form id="changem" action="ChangeMServlet" method="post">
                                  	...
                                  	<h3>Old Mobile:</h3>
										<div class="wrapper">
										<div class="bg"><input class="tb5" type="text" name="omobile"></div>
									...
									<h3>New Mobile:</h3>
										...
										<br>
										<br>
<a href="#" class="button" onclick="document.getElementById('changem').submit()"><span><span><strong>Change</strong></span></span></a>
<a href="#" class="button" onclick="location.href='changeMobile.jsp'"><span><span><strong>Reset</strong></span></span></a>
									</form>
